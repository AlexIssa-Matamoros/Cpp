...
void cargarLibros() {
	...
	libros[0][0] = "Algoritmos"; libros[0][1] = "Algoritmos y Programacion (Guia para docentes)"; libros[0][2] = "Alex";
	libros[1][0] = "Algoritmos"; libros[1][1] = "Apuntes de Algoritmos y Estructuras de Datos"; libros[1][2] = "Triple H";
	libros[2][0] = "Algoritmos"; libros[2][1] = "Breves Notas sobre Analisis de Algoritmos"; libros[2][2] = "John Cena";
	libros[3][0] = "Algoritmos"; libros[3][1] = "Fundamentos de Informatica y Programacion"; libros[3][2] = "Vader";
	libros[4][0] = "Algoritmos"; libros[4][1] = "Temas selectos de estructuras de datos"; libros[4][2] = "Luke";
	libros[5][0] = "Algoritmos"; libros[5][1] = "Teoria sintactico-gramatical de objetos"; libros[5][2] = "Optimus";
    ...
    while (salir == false)
    {
        ...
        for (int i = 0; i < 39; i++)
        {
            ...
            if (autorEnminuscula.find(buscar) != string::npos || libroEnminuscula.find(buscar) != string::npos) {
                 cout << "Autor del libro encontrado: " << autor << endl;
                 cout << "libro encontrado: " << libro << endl;
                 cout << "Tambien te sugerimos estos autores de libros: " << endl;
